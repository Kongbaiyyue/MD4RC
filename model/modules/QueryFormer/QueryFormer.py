...
class FeatureEmbed(nn.Module):
    ...
    def getType(self, typeId):
        # print("typeid max", torch.max(typeId))
    ...
    def getTable(self, table_sample):
        ...
        # print("table max", torch.max(table))
    ...
    def getJoin(self, joinId):
        # print("join max", torch.max(joinId))
    ...
    def getFilter(self, filtersId, filtersMask):
        ...
        # print("columns max", torch.max(colsId))
        # print("ops max", torch.max(opsId))
...
class QueryFormer(nn.Module):
    ...
    def forward(self, batched_data):
        ...
        # rel pos
        # print("rel pos max", torch.max(rel_pos))
        # print("heigth max", torch.max(heights))
